...
export const MOCK_MEMBERS: GroupMemberSummary[] = [
  { avatar: 'MT', correctPicks: 18, id: '1', isCurrentUser: false, name: 'Mike T.', rank: 1, totalPicks: 30 },
  { avatar: 'SK', correctPicks: 16, id: '2', isCurrentUser: false, name: 'Sarah K.', rank: 2, totalPicks: 30 },
  { avatar: 'YO', correctPicks: 15, id: '3', isCurrentUser: true, name: 'You', rank: 3, totalPicks: 30 },
  { avatar: 'JL', correctPicks: 14, id: '4', isCurrentUser: false, name: 'Jake L.', rank: 4, totalPicks: 30 },
  { avatar: 'ER', correctPicks: 12, id: '5', isCurrentUser: false, name: 'Emma R.', rank: 5, totalPicks: 30 },
  { avatar: 'CP', correctPicks: 10, id: '6', isCurrentUser: false, name: 'Chris P.', rank: 6, totalPicks: 30 },
];
