...
import { PostseasonPicks, TeamPick } from '@/types';
...
const MlbPostseasonPicks = ({
	initialPicks,
	onPicksChange,
	teamPicks,
}: MlbPostseasonPicksProps) => {
				...
				<CardContent>
					...
					{alPicks.length > 0 && (
						<div className="bg-muted/50 mt-4 rounded-lg p-3">
							<p className="text-muted-foreground mb-2 text-xs font-medium">Your picks:</p>
