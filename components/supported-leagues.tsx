    ...
    <section className="py-16 sm:py-24" id="leagues">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-serif text-3xl font-medium tracking-tight text-foreground sm:text-4xl">Pick your sport</h2>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {leagues.map((league) => (
              <Badge
                className="cursor-default px-4 py-2 text-base font-medium transition-all hover:bg-secondary/80 hover:shadow-sm"
                key={league.name}
                variant="secondary"
              >
