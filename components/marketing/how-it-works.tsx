    ...
    <section className="bg-muted/30 py-16 sm:py-24" id="how-it-works">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-serif text-3xl font-medium tracking-tight text-foreground sm:text-4xl">How it works</h2>
            ...
            <div className="group relative" key={step.title}>
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <div className="relative">
                  <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-card shadow-sm ring-1 ring-border/50 transition-all group-hover:shadow-md group-hover:ring-primary/20">
